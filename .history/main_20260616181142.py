    ...
    html_block(
        ...
        <section class="rd-section" id="cases">
            ...
            <div class="rd-evidence-grid">
                ...
                <div class="rd-evidence-card"><span>Цена</span><h3>1&nbsp;₽ → 29&nbsp;900&nbsp;₽</h3><p>Разовый вход и подписка для регулярных запусков.</p></div>
    ...
    html_block(
        ...
        <section class="rd-section" id="economics">
            ...
            <div class="rd-price-grid">
                <div class="rd-price"><h3>Разовый отчет</h3><div class="rd-price-value">1&nbsp;₽</div><div class="rd-price-sub">за 1 исследование</div><ul><li>Один город, район или категория</li><li>Короткий отчет с источниками и рисками</li><li>Низкий вход для первого платного пилота</li></ul><div class="rd-badge">Вход в продукт</div></div>
        ...
        <section class="rd-section" id="faq">
            <div class="rd-faq-grid">
                ...
                <div class="rd-faq-list">
                    ...
                    <details class="rd-faq"><summary>Как зарабатывает продукт?</summary><p>Разовый отчет за 1&nbsp;₽, SaaS-подписки 14&nbsp;900/29&nbsp;900&nbsp;₽ в месяц, API от 49&nbsp;900&nbsp;₽ и внедрение от 249&nbsp;900&nbsp;₽.</p></details>
