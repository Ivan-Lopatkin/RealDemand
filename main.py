...
def render_mvp() -> None:
    html(
        ...
        <section class="rd-section" id="mvp">
            ...
            <div style="margin:30px 0 18px;"><div class="rd-eyebrow">Что меряем на старте</div></div>
            <div class="rd-grid-3">
                <div class="rd-card amber"><div class="tag">готовность платить</div><strong>Конверсия в платный отчёт</strong><p>Сколько предпринимателей из тех, кто попробовал демо, покупают платный отчёт. Главный сигнал спроса на старте.</p></div>
                <div class="rd-card"><div class="tag">польза</div><strong>Действие после отчёта</strong><p>Доля клиентов, которые после отчёта связались с арендодателем или поехали смотреть помещение.</p></div>
                <div class="rd-card teal"><div class="tag">доверие</div><strong>Возвраты и рекомендации</strong><p>Возвращаются ли за вторым отчётом и приводят ли других предпринимателей.</p></div>
            </div>
            <div style="margin:30px 0 18px;"><div class="rd-eyebrow">Риски и как снижаем</div></div>
            <div class="rd-grid-2">
                <div class="rd-card coral"><div class="tag">риски</div><strong>Данные, копирование, законность, цикл продаж</strong><p>Объявления дублируются и устаревают, крупные игроки могут скопировать аналитический слой, сбор данных с чужих площадок несёт правовой риск, а сделки с сетями закрываются медленно.</p></div>
                <div class="rd-card teal"><div class="tag">как снижаем</div><strong>Гибрид данных, правовая проверка, разные циклы</strong><p>Несколько источников и удаление дублей; открытые и партнёрские данные вместо агрессивного сбора с чужих площадок; объяснимый балл против копирования; короткий разовый отчёт кормит компанию, пока зреют пилоты с сетями.</p></div>
            </div>
        </section>
        """
    )
